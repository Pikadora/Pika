...
'''
В конфигурационном файле у каждого сервера прописан список установленных на нем критических сервисов, который поступает в качестве аргумента к функции.
Вторым аргументом является адрес сервера, для удобного отслеживания выполнения проверок на сервере.
